...
function DrawingsPage_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", vm_r1.language === "it" ? "Nel disegno il gesto arriva prima delle parole. La carta trattiene l\u2019intuizione nel momento in cui appare: fragile, immediata, ancora vicina al suo mistero." : "In drawing, gesture comes before words. Paper holds intuition at the moment it appears: fragile, immediate and still close to its mystery.", " ");
    \u0275\u0275advance();
  ...
  <section class="mx-auto max-w-7xl px-5 pb-4 pt-16 sm:px-8 lg:px-12">
    <div class="max-w-3xl py-10">
      ...
      <p class="mt-5 text-sm leading-8 text-[var(--site-muted)] sm:text-base">
        {{
          vm.language === 'it'
            ? 'Nel disegno il gesto arriva prima delle parole. La carta trattiene l\u2019intuizione nel momento in cui appare: fragile, immediata, ancora vicina al suo mistero.'
            : 'In drawing, gesture comes before words. Paper holds intuition at the moment it appears: fragile, immediate and still close to its mystery.'
        }}
      </p>
    </div>
  </section>
...
//# sourceMappingURL=chunk-GH2Y755H.js.map
