...
function AboutPage_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "app-hero-section", 1)(2, "app-split-section", 2)(3, "app-quote-section", 3)(4, "app-editorial-section", 4)(5, "app-split-section", 5)(6, "app-large-image-section", 6)(7, "app-manifesto-section", 7)(8, "app-cta-section", 8);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const vm_r1 = ctx;
...
var AboutPage = class _AboutPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AboutPage, selectors: [["app-about-page"]], decls: 2, vars: 3, consts: [[1, "about-page"], [3, "image", "title", "subtitle", "scrollLabel"], [3, "eyebrow", "title", "paragraphs", "image", "imageAlt"], [3, "image", "imageAlt", "quote"], [3, "eyebrow", "title", "items", "image", "imageAlt"], [3, "eyebrow", "title", "paragraphs", "image", "imageAlt", "reverse"], [3, "eyebrow", "title", "image", "imageAlt", "paragraphs"], [3, "eyebrow", "phrases"], [3, "image", "imageAlt", "title", "body", "actions"]], template: function AboutPage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, AboutPage_Conditional_0_Template, 9, 81, "article", 0);
      \u0275\u0275pipe(1, "async");
    }
    if (rf & 2) {
      let tmp_0_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AboutPage, { className: "AboutPage", filePath: "sito-artista/src/app/pages/about/about.page.ts", lineNumber: 33 });
})();
export {
  AboutPage
};
//# sourceMappingURL=chunk-LNYTH7T7.js.map
