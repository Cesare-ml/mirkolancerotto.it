...
function ContactFormComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 11)(9, "p", 12);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "dl", 13)(12, "div")(13, "dt");
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 14)(23, "dt");
    \u0275\u0275text(24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "dd");
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 14)(28, "dt");
    \u0275\u0275text(29);
    \u0275\u0275elementEnd();
...
function ContactFormComponent_Conditional_3_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28)(1, "p", 31);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ContactFormComponent_Conditional_3_Conditional_28_Conditional_3_Template, 2, 1, "button", 32);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function ContactFormComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(0, ContactFormComponent_Conditional_3_Conditional_0_Template, 3, 1, "div", 16);
    ...
    \u0275\u0275conditionalCreate(7, ContactFormComponent_Conditional_3_Conditional_7_Template, 2, 2, "p", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 19)(9, "label", 20);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "input", 23);
    \u0275\u0275conditionalCreate(12, ContactFormComponent_Conditional_3_Conditional_12_Template, 2, 2, "p", 22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 19)(14, "label", 20);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275element(16, "input", 24);
    \u0275\u0275conditionalCreate(17, ContactFormComponent_Conditional_3_Conditional_17_Template, 2, 2, "p", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 19)(19, "label", 20);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275element(21, "textarea", 25);
    \u0275\u0275conditionalCreate(22, ContactFormComponent_Conditional_3_Conditional_22_Template, 2, 2, "p", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 19)(24, "p", 26);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd();
    \u0275\u0275element(26, "div", 27, 1);
    \u0275\u0275conditionalCreate(28, ContactFormComponent_Conditional_3_Conditional_28_Template, 4, 2, "div", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 29)(30, "button", 30);
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ContactFormComponent, [{
    type: Component,
    args: [{ selector: "app-contact-form", standalone: true, imports: [CommonModule, ReactiveFormsModule], template: `<section class="contact-form rounded-[1.9rem] border border-[var(--site-border)] bg-[var(--site-surface)] p-6 sm:p-8">
  @if (!submittedMessage) {
    <div class="max-w-2xl">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactFormComponent, { className: "ContactFormComponent", filePath: "sito-artista/src/app/components/contact-form/contact-form.component.ts", lineNumber: 42 });
})();
...
function ContactsPage_Conditional_0_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-newsletter", 10);
  }
  if (rf & 2) {
...
function ContactsPage_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "app-contact-form", 3);
    \u0275\u0275elementStart(4, "div", 4)(5, "div", 5)(6, "p", 6);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(vm_r1.pagesConfig.contacts.showNewsletter ? 12 : -1);
  }
}
var ContactsPage = class _ContactsPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactsPage, selectors: [["app-contacts-page"]], decls: 2, vars: 3, consts: [["height", "compact", 3, "image", "title", "subtitle", "ctaPrimary"], [1, "mx-auto", "max-w-7xl", "px-5", "py-14", "sm:px-8", "lg:px-12"], [1, "grid", "gap-6", "xl:grid-cols-[1.08fr_0.92fr]"], [3, "language", "config"], [1, "space-y-6"], [1, "rounded-[1.75rem]", "border", "border-[var(--site-border)]", "bg-[var(--site-surface)]", "p-8"], [1, "text-xs", "uppercase", "tracking-[0.28em]", "text-[var(--site-muted)]"], [1, "mt-4", "block", "text-2xl", "text-[var(--site-text)]", "no-underline", 3, "href"], [1, "mt-8"], [3, "socialLinks", "monochrome"], [3, "siteConfig", "language"]], template: function ContactsPage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, ContactsPage_Conditional_0_Template, 13, 15);
      \u0275\u0275pipe(1, "async");
    }
    if (rf & 2) {
      let tmp_0_0;
  ...
  }, dependencies: [HeroComponent, ContactFormComponent, NewsletterComponent, SocialLinksComponent, AsyncPipe], styles: ["\n\n[_nghost-%COMP%] {\n  display: block;\n}\n/*# sourceMappingURL=contacts.page.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ContactsPage, [{
    type: Component,
    args: [{ selector: "app-contacts-page", standalone: true, imports: [AsyncPipe, HeroComponent, ContactFormComponent, NewsletterComponent, SocialLinksComponent], template: `@if (vm$ | async; as vm) {
  <app-hero
  ...
  <section class="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-12">
    <div class="grid gap-6 xl:grid-cols-[1.08fr_0.92fr]">
      ...
      <div class="space-y-6">
        <div class="rounded-[1.75rem] border border-[var(--site-border)] bg-[var(--site-surface)] p-8">
          <p class="text-xs uppercase tracking-[0.28em] text-[var(--site-muted)]">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactsPage, { className: "ContactsPage", filePath: "sito-artista/src/app/pages/contacts/contacts.page.ts", lineNumber: 21 });
})();
export {
  ContactsPage
};
//# sourceMappingURL=chunk-7YHJYO4E.js.map
