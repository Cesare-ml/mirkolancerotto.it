...
function ArtworkCardComponent_Conditional_1_Conditional_5_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r0.auctionPill, " ");
  }
}
...
function ArtworkCardComponent_Conditional_1_Conditional_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ArtworkCardComponent_Conditional_1_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ArtworkCardComponent_Conditional_1_Conditional_5_Conditional_1_Template, 2, 1, "p", 10);
    \u0275\u0275conditionalCreate(2, ArtworkCardComponent_Conditional_1_Conditional_5_Conditional_2_Template, 2, 5, "p", 11);
    \u0275\u0275conditionalCreate(3, ArtworkCardComponent_Conditional_1_Conditional_5_Conditional_3_Template, 3, 6, "p", 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.auctionPill ? 1 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.showStatus ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.artwork.price.visible && ctx_r0.artwork.price.amount ? 3 : -1);
  }
}
...
function ArtworkCardComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(5, ArtworkCardComponent_Conditional_1_Conditional_5_Template, 4, 3, "div", 6);
...
function ArtworkCardComponent_Conditional_2_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function ArtworkCardComponent_Conditional_2_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
...
function ArtworkCardComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 2)(1, "div", 14);
    \u0275\u0275element(2, "img", 15);
    \u0275\u0275pipe(3, "localizedText");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 16);
    \u0275\u0275conditionalCreate(5, ArtworkCardComponent_Conditional_2_Conditional_5_Template, 2, 1, "p", 17);
    \u0275\u0275conditionalCreate(6, ArtworkCardComponent_Conditional_2_Conditional_6_Template, 2, 1, "p", 18);
    \u0275\u0275elementStart(7, "h3", 19);
    \u0275\u0275text(8);
    \u0275\u0275pipe(9, "localizedText");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "p", 20);
    \u0275\u0275text(11);
    \u0275\u0275pipe(12, "localizedText");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, ArtworkCardComponent_Conditional_2_Conditional_13_Template, 3, 6, "p", 21);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("routerLink", ctx_r0.artworkLink);
    \u0275\u0275advance(2);
    \u0275\u0275property("src", ctx_r0.artwork.images.main.sources.large, \u0275\u0275sanitizeUrl)("alt", \u0275\u0275pipeBind2(3, 9, ctx_r0.artwork.images.main.alt, ctx_r0.language));
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.auctionPill ? 5 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.showStatus ? 6 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(9, 12, ctx_r0.artwork.title, ctx_r0.language), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2(" ", ctx_r0.artwork.year, " \xB7 ", \u0275\u0275pipeBind2(12, 15, ctx_r0.artwork.technique, ctx_r0.language), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.artwork.price.visible && ctx_r0.artwork.price.amount ? 13 : -1);
  }
}
var ArtworkCardComponent = class _ArtworkCardComponent {
  ...
  get auctionPill() {
    if (!this.artwork.auction) {
      return null;
    }
    if (this.artwork.auction.publicStatus === "live") {
      return this.language === "it" ? "In asta" : "At auction";
    }
    if (this.artwork.auction.publicStatus === "upcoming") {
      return this.language === "it" ? "Asta in arrivo" : "Auction soon";
    }
  ...
  @if (variant === 'editorial') {
      ...
      <div class="artwork-card__content artwork-card__content--editorial">
        @if (shouldShowMetaRow) {
          <div class="artwork-card__meta-row mb-4 flex flex-wrap items-center gap-3">
            @if (auctionPill) {
              <p class="artwork-card__auction text-[11px] uppercase tracking-[0.25em]">
                {{ auctionPill }}
              </p>
            }
            @if (showStatus) {
    ...
    <a [routerLink]="artworkLink" class="artwork-card__link block no-underline">
      ...
      <div class="artwork-card__content p-5 sm:p-6">
        @if (auctionPill) {
          <p class="artwork-card__auction mb-3 text-[11px] uppercase tracking-[0.25em]">
            {{ auctionPill }}
          </p>
        }
        @if (showStatus) {
...
//# sourceMappingURL=chunk-B2JSZP5S.js.map
