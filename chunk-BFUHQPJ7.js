...
var COMMISSIONS_CONTENT = {
  ...
  heroSubtitle: {
    it: "Mi emoziona creare un\u2019opera insieme a chi crede ancora che l\u2019arte possa abitare una casa come una presenza viva: non un oggetto silenzioso, ma qualcosa capace di parlarci dentro ogni giorno.",
    en: "I love creating an artwork together with those who still believe art can inhabit a home as a living presence: not a silent object, but something able to speak within us every day."
  },
  introEyebrow: {
    it: "Percorso",
    en: "Approach"
...
function CommissionsPage_Conditional_0_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(2, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 33)(4, "div", 34)(5, "p", 35);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(9, "currency");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 34)(11, "p", 35);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
...
function CommissionsPage_Conditional_0_For_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article", 24)(1, "figure", 37);
    \u0275\u0275element(2, "img", 38);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const \u0275$index_110_r7 = ctx.$index;
    const vm_r4 = \u0275\u0275nextContext();
    \u0275\u0275property("revealDelay", \u0275$index_110_r7 * 90);
    \u0275\u0275advance(2);
    \u0275\u0275property("src", step_r6.image, \u0275\u0275sanitizeUrl)("alt", step_r6.imageAlt[vm_r4.language] || step_r6.imageAlt.it);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", vm_r4.language === "it" ? "Fase" : "Step", " ", (\u0275$index_110_r7 + 1).toString().padStart(2, "0"), " ");
    \u0275\u0275advance(2);
...
function CommissionsPage_Conditional_0_For_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "blockquote", 27)(1, "figure", 37);
    \u0275\u0275element(2, "img", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 43);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "footer", 44)(6, "p", 45);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const reflection_r8 = ctx.$implicit;
    const \u0275$index_138_r9 = ctx.$index;
    const vm_r4 = \u0275\u0275nextContext();
    \u0275\u0275property("revealDelay", \u0275$index_138_r9 * 100);
    \u0275\u0275advance(2);
    \u0275\u0275property("src", reflection_r8.image, \u0275\u0275sanitizeUrl)("alt", reflection_r8.imageAlt[vm_r4.language] || reflection_r8.imageAlt.it);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" \u201C", reflection_r8.quote[vm_r4.language] || reflection_r8.quote.it, "\u201D ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(reflection_r8.author);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", reflection_r8.context[vm_r4.language] || reflection_r8.context.it, " ");
  }
}
function CommissionsPage_Conditional_0_Conditional_59_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-artwork-card", 47);
  }
  if (rf & 2) {
    const artwork_r10 = ctx.$implicit;
    const \u0275$index_172_r11 = ctx.$index;
    const vm_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275property("revealDelay", \u0275$index_172_r11 * 90)("artwork", artwork_r10)("language", vm_r4.language)("variant", "editorial");
  }
}
function CommissionsPage_Conditional_0_Conditional_59_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 25)(1, "div", 20)(2, "p", 4);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(9, CommissionsPage_Conditional_0_Conditional_59_For_10_Template, 1, 4, "app-artwork-card", 47, _forTrack2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const vm_r4 = \u0275\u0275nextContext();
...
function CommissionsPage_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(48, CommissionsPage_Conditional_0_For_49_Template, 9, 7, "article", 24, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(50, "section", 25)(51, "div", 20)(52, "p", 4);
    \u0275\u0275text(53);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(57, CommissionsPage_Conditional_0_For_58_Template, 10, 6, "blockquote", 27, _forTrack1);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(59, CommissionsPage_Conditional_0_Conditional_59_Template, 11, 3, "section", 25);
    \u0275\u0275elementStart(60, "section", 25)(61, "div", 28)(62, "div", 29)(63, "h2", 30);
    \u0275\u0275text(64);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const vm_r4 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("image", vm_r4.pagesConfig.commissions.heroImage)("title", vm_r4.content.heroTitle[vm_r4.language] || vm_r4.content.heroTitle.it)("subtitle", vm_r4.content.heroSubtitle[vm_r4.language] || vm_r4.content.heroSubtitle.it)("ctaPrimary", \u0275\u0275pureFunction2(29, _c0, vm_r4.language === "it" ? "Contatta l\u2019artista" : "Contact the artist", vm_r4.contactsPath));
    \u0275\u0275advance(5);
...
var CommissionsPage = class _CommissionsPage {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CommissionsPage, selectors: [["app-commissions-page"]], decls: 2, vars: 3, consts: [["height", "large", 3, "image", "title", "subtitle", "ctaPrimary"], [1, "commissions-shell", "mx-auto", "max-w-7xl", "px-5", "py-14", "sm:px-8", "lg:px-12"], [1, "commissions-intro", "grid", "gap-8", "lg:grid-cols-[minmax(0,1.05fr)_minmax(22rem,0.95fr)]", "lg:items-start"], ["appRevealOnScroll", "", "revealVariant", "left", 1, "commissions-panel", "rounded-[2rem]", "p-7", "sm:p-9"], [1, "text-xs", "uppercase", "tracking-[0.3em]", "text-[var(--site-muted)]"], [1, "mt-5", "max-w-3xl", "text-4xl", "leading-tight", "text-[var(--site-text)]", "sm:text-5xl"], [1, "mt-6", "max-w-3xl", "text-base", "leading-8", "text-[var(--site-text)]/76", "sm:text-lg"], ["appRevealOnScroll", "", "revealVariant", "right", 1, "commissions-panel", "commissions-estimate", "rounded-[2rem]", "p-7", "sm:p-9", 3, "revealDelay"], [1, "mt-5", "text-3xl", "leading-tight", "text-[var(--site-text)]"], [1, "mt-5", "text-sm", "leading-8", "text-[var(--site-muted)]"], [1, "mt-8", "grid", "gap-4", "sm:grid-cols-2"], [1, "commissions-estimate__field"], [1, "commissions-estimate__select", 3, "change", "value"], [3, "value", "disabled"], [1, "commissions-estimate__result", "mt-8", "rounded-[1.5rem]", "px-5", "py-5"], [1, "text-[11px]", "uppercase", "tracking-[0.28em]", "text-[var(--site-muted)]"], [1, "mt-3", "text-xl", "leading-8", "text-[var(--site-text)]"], [1, "mt-3", "text-sm", "leading-7", "text-[var(--site-muted)]"], [1, "mt-2", "text-sm", "leading-7", "text-[var(--site-muted)]"], [1, "commissions-process", "mt-16"], ["appRevealOnScroll", "", 1, "max-w-3xl"], [1, "mt-5", "text-4xl", "leading-tight", "text-[var(--site-text)]", "sm:text-5xl"], [1, "mt-5", "text-base", "leading-8", "text-[var(--site-text)]/76", "sm:text-lg"], [1, "commissions-process__grid", "mt-10", "grid", "gap-5", "lg:grid-cols-2"], ["appRevealOnScroll", "", 1, "commissions-panel", "commissions-step", "rounded-[1.75rem]", "p-6", "sm:p-7", 3, "revealDelay"], [1, "mt-16"], [1, "mt-10", "grid", "gap-5", "lg:grid-cols-3"], ["appRevealOnScroll", "", 1, "commissions-panel", "commissions-panel--quote", "commissions-reflection", "rounded-[1.75rem]", "p-6", "sm:p-7", 3, "revealDelay"], ["appRevealOnScroll", "", "revealVariant", "scale", 1, "commissions-panel", "commissions-cta", "rounded-[2rem]", "p-7", "sm:p-9", "lg:grid", "lg:grid-cols-[minmax(0,1fr)_auto]", "lg:items-end", "lg:gap-10"], [1, "max-w-3xl"], [1, "text-3xl", "leading-tight", "text-[var(--site-text)]", "sm:text-4xl"], [1, "mt-8", "inline-flex", "rounded-full", "bg-[var(--site-text)]", "px-6", "py-3", "text-xs", "uppercase", "tracking-[0.22em]", "text-white", "no-underline", "lg:mt-0", 3, "routerLink"], [1, "mt-3", "text-3xl", "text-[var(--site-text)]", "sm:text-4xl"], [1, "mt-5", "grid", "gap-3", "sm:grid-cols-2"], [1, "commissions-estimate__split", "rounded-[1.2rem]", "px-4", "py-4"], [1, "text-[11px]", "uppercase", "tracking-[0.24em]", "text-[var(--site-muted)]"], [1, "mt-2", "text-xl", "text-[var(--site-text)]"], [1, "overflow-hidden", "rounded-[1.2rem]"], [1, "h-56", "w-full", "object-cover", 3, "src", "alt"], [1, "text-xs", "uppercase", "tracking-[0.28em]", "text-[var(--site-muted)]"], [1, "mt-4", "text-2xl", "text-[var(--site-text)]"], [1, "mt-4", "text-sm", "leading-8", "text-[var(--site-muted)]"], [1, "h-48", "w-full", "object-cover", 3, "src", "alt"], [1, "text-lg", "leading-9", "text-[var(--site-text)]/85"], [1, "mt-6", "border-t", "border-[rgba(188,160,129,0.18)]", "pt-4"], [1, "text-sm", "uppercase", "tracking-[0.24em]", "text-[var(--site-text)]"], [1, "mt-10", "space-y-8"], ["appRevealOnScroll", "", "revealVariant", "image", 3, "revealDelay", "artwork", "language", "variant"]], template: function CommissionsPage_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, CommissionsPage_Conditional_0_Template, 69, 32);
      \u0275\u0275pipe(1, "async");
    }
    if (rf & 2) {
      let tmp_0_0;
...
(() => {
  ...
  <section class="commissions-shell mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-12">
    <div class="commissions-intro grid gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(22rem,0.95fr)] lg:items-start">
      <div class="commissions-panel rounded-[2rem] p-7 sm:p-9" appRevealOnScroll revealVariant="left">
      ...
      <aside class="commissions-panel commissions-estimate rounded-[2rem] p-7 sm:p-9" appRevealOnScroll revealVariant="right" [revealDelay]="110">
        <p class="text-xs uppercase tracking-[0.3em] text-[var(--site-muted)]">
    ...
    <section class="commissions-process mt-16">
      ...
      <div class="commissions-process__grid mt-10 grid gap-5 lg:grid-cols-2">
        @for (step of vm.content.steps; track step.title.it; let index = $index) {
          <article class="commissions-panel commissions-step rounded-[1.75rem] p-6 sm:p-7" appRevealOnScroll [revealDelay]="index * 90">
            ...
            <p class="text-xs uppercase tracking-[0.28em] text-[var(--site-muted)]">
              {{ vm.language === 'it' ? 'Fase' : 'Step' }} {{ (index + 1).toString().padStart(2, '0') }}
            </p>
    ...
    <section class="mt-16">
      ...
      <div class="mt-10 grid gap-5 lg:grid-cols-3">
        @for (reflection of vm.content.reflections; track reflection.quote.it; let index = $index) {
          <blockquote class="commissions-panel commissions-panel--quote commissions-reflection rounded-[1.75rem] p-6 sm:p-7" appRevealOnScroll [revealDelay]="index * 100">
            <figure class="overflow-hidden rounded-[1.2rem]">
              <img
    ...
    @if (vm.featuredWorks.length > 0) {
      <section class="mt-16">
        ...
        <div class="mt-10 space-y-8">
          @for (artwork of vm.featuredWorks; track artwork.id; let index = $index) {
            <app-artwork-card appRevealOnScroll revealVariant="image" [revealDelay]="index * 90" [artwork]="artwork" [language]="vm.language" [variant]="'editorial'"></app-artwork-card>
          }
        </div>
      </section>
    }
    ...
    <section class="mt-16">
      <div class="commissions-panel commissions-cta rounded-[2rem] p-7 sm:p-9 lg:grid lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end lg:gap-10" appRevealOnScroll revealVariant="scale">
        <div class="max-w-3xl">
...
`, styles: ['/* sito-artista/src/app/pages/commissions/commissions.page.sass */\n:host {\n  display: block;\n}\n.commissions-shell {\n  position: relative;\n}\n.commissions-shell::before {\n  content: "";\n  position: absolute;\n  z-index: -1;\n  top: 28rem;\n  left: -16rem;\n  width: 38rem;\n  height: 38rem;\n  border-radius: 50%;\n  background:\n    radial-gradient(\n      circle,\n      rgba(159, 116, 82, 0.08),\n      transparent 70%);\n  pointer-events: none;\n}\n.commissions-panel {\n  border: 1px solid rgba(188, 160, 129, 0.22);\n  background:\n    linear-gradient(\n      180deg,\n      rgba(255, 251, 246, 0.96),\n      rgba(252, 246, 239, 0.98));\n  box-shadow: 0 24px 70px rgba(105, 72, 44, 0.08);\n}\n.commissions-panel--quote {\n  background:\n    linear-gradient(\n      180deg,\n      rgba(255, 252, 248, 0.98),\n      rgba(250, 244, 236, 0.98));\n}\n.commissions-panel figure + p {\n  margin-top: 1.4rem;\n}\n.commissions-process__grid {\n  position: relative;\n}\n.commissions-step,\n.commissions-reflection {\n  transition:\n    transform 550ms cubic-bezier(0.22, 1, 0.36, 1),\n    box-shadow 550ms ease,\n    border-color 550ms ease;\n}\n.commissions-step figure,\n.commissions-reflection figure {\n  position: relative;\n}\n.commissions-step figure::after,\n.commissions-reflection figure::after {\n  content: "";\n  position: absolute;\n  inset: 0;\n  background:\n    linear-gradient(\n      135deg,\n      transparent 55%,\n      rgba(255, 248, 239, 0.2));\n  pointer-events: none;\n}\n.commissions-step img,\n.commissions-reflection img {\n  transition: transform 800ms cubic-bezier(0.22, 1, 0.36, 1);\n}\n.commissions-step:hover,\n.commissions-reflection:hover {\n  border-color: rgba(159, 116, 82, 0.34);\n  box-shadow: 0 30px 76px rgba(105, 72, 44, 0.12);\n  transform: translateY(-0.35rem);\n}\n.commissions-step:hover img,\n.commissions-reflection:hover img {\n  transform: scale(1.035);\n}\n.commissions-cta {\n  overflow: hidden;\n  background:\n    radial-gradient(\n      circle at 92% 0%,\n      rgba(159, 116, 82, 0.14),\n      transparent 22rem),\n    linear-gradient(\n      180deg,\n      rgba(255, 251, 246, 0.98),\n      rgba(250, 244, 236, 0.98));\n}\n.commissions-estimate__field {\n  display: grid;\n  gap: 0.75rem;\n}\n.commissions-estimate__field span {\n  font-size: 0.72rem;\n  text-transform: uppercase;\n  letter-spacing: 0.22em;\n  color: var(--site-muted);\n}\n.commissions-estimate__select {\n  width: 100%;\n  border: 1px solid rgba(188, 160, 129, 0.28);\n  border-radius: 999px;\n  background: rgba(255, 253, 249, 0.96);\n  padding: 0.95rem 1.1rem;\n  color: var(--site-text);\n  font-size: 0.98rem;\n  outline: none;\n  transition: border-color 0.24s ease, box-shadow 0.24s ease;\n}\n.commissions-estimate__select:focus {\n  border-color: rgba(159, 116, 82, 0.42);\n  box-shadow: 0 0 0 3px rgba(159, 116, 82, 0.08);\n}\n.commissions-estimate__result {\n  border: 1px solid rgba(188, 160, 129, 0.18);\n  background: rgba(255, 253, 249, 0.85);\n}\n.commissions-estimate__split {\n  border: 1px solid rgba(188, 160, 129, 0.16);\n  background: rgba(255, 255, 255, 0.72);\n}\n@media (prefers-reduced-motion: reduce) {\n  .commissions-step,\n  .commissions-reflection {\n    transition: none;\n  }\n  .commissions-step img,\n  .commissions-reflection img {\n    transition: none;\n  }\n}\n/*# sourceMappingURL=commissions.page.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CommissionsPage, { className: "CommissionsPage", filePath: "sito-artista/src/app/pages/commissions/commissions.page.ts", lineNumber: 22 });
})();
export {
  CommissionsPage
};
//# sourceMappingURL=chunk-BFUHQPJ7.js.map
