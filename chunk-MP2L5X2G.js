...
function ArtworksPage_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", vm_r1.language === "it" ? "Dipingo per dare forma a ci\xF2 che non riesce a restare soltanto pensiero: presenze, visioni e silenzi che chiedono di entrare nel mondo." : "I paint to give form to what cannot remain only a thought: presences, visions and silences asking to enter the world.", " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", vm_r1.language === "it" ? "Ogni opera continua a cambiare con la luce, con lo spazio e con chi la guarda." : "Each artwork keeps changing with the light, the space and the person looking at it.", " ");
    \u0275\u0275advance();
    ...
    <div class="mx-auto max-w-7xl">
      <div class="artworks-page__hero-copy relative z-[1] max-w-2xl py-10 sm:py-14">
        ...
        <p class="mt-5 max-w-xl text-sm leading-8 text-[var(--site-muted)] sm:text-base">
          {{
            vm.language === 'it'
              ? 'Dipingo per dare forma a ci\xF2 che non riesce a restare soltanto pensiero: presenze, visioni e silenzi che chiedono di entrare nel mondo.'
...
//# sourceMappingURL=chunk-MP2L5X2G.js.map
